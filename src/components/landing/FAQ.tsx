...
const FAQS = [
  {
    ...
    a: "10 Aura ≈ 1 image. Budget video starts at 100 Aura and lip-sync at 30; premium models cost more, priced to match each model. Length and resolution scale the price. Aura never expires and rolls across every model.",
  },
  {
