  ...
  return (
    <section className="relative px-6 md:px-12 py-20 overflow-hidden">
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, oklch(0.62 0.20 300), transparent 65%)" }}
      />

      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary text-[11px] font-semibold tracking-wide mb-5">
            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {TRUST_POINTS.map(({ icon: Icon, label, desc }) => (
                  <div key={label} className="flex gap-3">
                    <div className="mt-0.5 flex-shrink-0 size-8 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full font-bold text-white no-underline bg-primary hover:bg-primary/90 shadow-[var(--shadow-glow-soft)] transition-all hover:scale-[1.02]"
                >
